    ...
    <footer>
        <div class="footer-content">
            <div class="contact-info">
                <p>Địa chỉ: Đường Cộng Hòa, Thành phố Hồ Chí Minh</p>
                <p>Email: cunnconn01@gmail.com</p>
                <p>Số điện thoại: 0971623293/ 0364994963</p>
            </div>
        ...
        <div class="social-media">
            <a href="https://www.facebook.com/nam.trinhphuong.1802?locale=vi_VN"><i class="fab fa-facebook-f"></i></a>
    ...
    <footer class="bg-white">
        ...
        <div class="bg-light py-2">
            <div class="container text-center">
                <p class="text-muted mb-0 py-2">&copy; 2023 Tất cả các quyền được bảo lưu.</p>
...
<script src="../js.js/js/bootstrap.bundle.js.map"></script>
</body>
