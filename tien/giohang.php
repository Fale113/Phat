...
<body>
    ...
    echo '<h5 style="color:red;">' . $_SESSION['dangky'] . '</h5>';
...
?>
    ...
    if (isset($_SESSION['cart'])) {
        ...
        foreach ($_SESSION['cart'] as $cart_item) {
            ...
            ?>
                <tr>
                    ...
                    <td><img src="../image/<?php echo $cart_item['thumbnail']; ?>" alt="" width="150px" height="150px">
                    </td>
                    <td>
                        <a href="../main/themgiohang.php?cong=<?php echo $cart_item['id'] ?>"><button
                                class="tang_giam">+</button></a>
                        <?php echo $cart_item['soluong']; ?>
                        <a href="../main/themgiohang.php?tru=<?php echo $cart_item['id'] ?>"><button
                                class="tang_giam">-</button></a>
                    </td>
        ...
        ?><tr>
                ...
                if (isset($_SESSION['dangky'])) {
                    ?>
                    <p><a href="index.php?quanly=vanchuyen"><button class="nut_dang_nhap">Hình thức vận
                                chuyển</button></a>
                    </p>
                    <?php
                } else {
