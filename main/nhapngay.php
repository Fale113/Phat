...
if($cart_query) {
    ...
    foreach($_SESSION['cart'] as $key => $value) {
        ...
        $max=$value['max'];
           // Lưu trữ số lượng vào mảng
           
    $quantityArray[$id_sanpham] = $soluong;
    ...
    // Lưu mảng số lượng vào session bằng cách sử dụng array_merge()
...
unset($_SESSION['cart']);
header('Location:../Web.php/index.php?quanly=thongtinthanhtoan');
